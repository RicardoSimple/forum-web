<template>
  <div>
    ...
    <el-card
      class="box-card"
      style="margin-left: 25%;background-color: #FFFFFF;overflow:auto; width: 50%;"
    >
      ...
      <p>传输和利用信息符合中国法律、国际公约的规定、符合公序良俗；
      </p>
      <p>不将本网站以及与之相关的网络服务用作非法用途以及非正当用途；
      </p>
      <p>不干扰和扰乱本网站以及与之相关的网络服务；
      </p>
      ...
      <p>第九条 本网站所涉及的一些单位或个人资料，本网站不会将客户的任何资料以任何方式泄露给任何一方。

      </p>
      <p>第十条
        当政府部门、司法机关等依照法定程序要求本网站披露用户资料时，本网站将根据执法单位之要求或为公共安全之目的提供个人资料。在此情况下之任何披露，本网站均得免责。
    ...
    >
      ...
      >
        <span>打赏作者/获取企业邀请码:</span>
      </div>
      <div>
        <el-image :src="require('../../assets/vx.png')"></el-image>
